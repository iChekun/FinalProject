...
public class ViewCustomerProductTableCommandImpl implements Command {
    ...
    public ViewCustomerProductTableCommandImpl(final HttpServletRequest request, final HttpServletResponse response) {
