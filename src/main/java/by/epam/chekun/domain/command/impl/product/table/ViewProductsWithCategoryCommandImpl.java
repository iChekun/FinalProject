...
public class ViewProductsWithCategoryCommandImpl implements Command {
    ...
    public ViewProductsWithCategoryCommandImpl(final HttpServletRequest request, final HttpServletResponse response) {
