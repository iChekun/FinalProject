...
public class ViewUsersTableCommandImpl implements Command {

    private final HttpServletRequest request;
    private final HttpServletResponse response;
    private final UserService userService = ServiceManager.getInstance().getUserService();

    public ViewUsersTableCommandImpl(final HttpServletRequest request, final HttpServletResponse response) {
